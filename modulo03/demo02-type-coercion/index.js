...
// vai retorn NaN, pois o toString retornou a string
// console.log('valueOf', Number(item))

// depois de adicionar o symbom.toPrimitive
console.log('toString', String(item))
console.log('valueOf', Number(item))
