...
console.log('new Object() si {}?', new Object().__proto__ === {}.__proto__)
...
// se não chamar o 'new', o primeiro __protp__ vai ser sempre
...
// Quando chamamos com o 'new' o __proto__ recebemos o prototype
console.log('manager.__proto__: %s, manager.salary(): %s', new Manager().__proto__.__proto__, new Manager().salary())
